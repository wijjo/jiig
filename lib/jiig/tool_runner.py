...
def run_tool(params: Dict):
    ...
    params_obj['TASK_FOLDERS'] = task_folders
    # Add the `help` task.
    ...
    cli_parser = parser.CommandLineParser(params_obj.TASK_FOLDERS)
