...
from jiig.util.console import log_message, log_error


class AliasDeleteTask(model.Task):
    """Delete alias."""
...
class AliasDescriptionTask(model.Task):
...
class AliasListTask(model.Task):
    """List aliases."""
...
class AliasRenameTask(model.Task):
    """Rename alias."""
...
class AliasShowTask(model.Task):
    """Display alias."""
