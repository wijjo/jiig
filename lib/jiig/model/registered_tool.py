...
from ._util import prepare_registered_text
...
class RegisteredTool(HelpProvider):
    ...
    def __init__(self,
        ...
        text_results = prepare_registered_text(configuration.description,
                                               tool_class.notes,
    ...
    def run(self,
        ...
        try:
            ...
            tool = self._tool_class(self.configuration,
                                    runtime_options,
                                    data,
                                    trailing_args,
                                    self)
    ...
    def format_tool_help(self, show_hidden: bool = False) -> Text:
        ...
        """
        formatter = HelpFormatter(self.configuration.tool_name,
                                  [],
                                  self.description,
