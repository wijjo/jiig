...
from jiig.util import alias_catalog
...
class Task:
    ...
    def __init__(self,
        ...
        :param is_secondary: not the primary task if True
        """
        assert name
        self.name = name
    ...
    def expand_string(self, text: Text, **more_params) -> Text:
        ...
        """
        return text.format(**self.configuration.expansion_symbols, **more_params)
    ...
    def open_alias_catalog(self) -> Iterator[alias_catalog.AliasCatalog]:
        ...
        with alias_catalog.open_alias_catalog(
                ...
                self.configuration.aliases_path) as catalog:
            yield catalog
