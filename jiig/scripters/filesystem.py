...
def create_folder(script: Script,
                  folder: str,
...
def create_parent_folder(script: Script,
                         path: str,
                         need_root: bool = False,
                         messages: dict = None,
                         ):
...
def delete_folder(script: Script,
                  folder: str,
                  need_root: bool = False,
                  messages: dict = None,
                  ):
...
def create_symlink(script: Script,
                   source: str,
                   target: str,
                   need_root: bool = False,
                   messages: dict = None,
...
def deploy_files(script: Script,
