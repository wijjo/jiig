...
from ._common import run_context_command, run_context_sub_process, open_context_output_file
...
def _script_start(context: Context, action_messages: AttributeDictionary):
...
def _script_finish(context: Context,
                   ...
                   unchecked: bool,
                   action_messages: AttributeDictionary,
                   ) -> subprocess.CompletedProcess:
    if proc.returncode == 0:
