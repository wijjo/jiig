...
class Runner:
    ...
    def __init__(self,
        ...
        :param prepared_application: prepared application data
        :param prepared_runtime: prepared runtime interface
        """
    ...
    def run_application(self):
        ...
        data_preparer = _ArgumentDataPreparer(self.prepared_application.driver_app_data.data)
        for task in self.prepared_application.task_stack:
        ...
        try:
            ...
            for run_name, run_function, run_kwargs in run_calls:
                ...
                try:
                    ...
                    run_function(self.prepared_runtime.runtime, **run_kwargs)
            ...
            if self.prepared_runtime.runtime.when_done_callables:
                for done_call in self.prepared_runtime.runtime.when_done_callables:
                    try:
            ...
            active_names = [
                ...
                for task_stack_item in self.prepared_application.task_stack
            ]
