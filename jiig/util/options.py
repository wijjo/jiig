...
class Options:
    ...
    def is_initialized(self) -> bool:
        ...
        Returns:
            True if options are considered initialized
        """
    ...
    def keep_files(self) -> bool:
        ...
        Returns:
            True if file preservation is enabled
        """
    ...
    def copy(self, other: 'Options'):
        ...
        Args:
            other: other Options instance to copy from
        """
